...
inline void vec_add_kernel(int8_t* a, int8_t* b, int8_t* c, ::std::size_t num) {
...
template<::std::size_t Kernel, ::std::size_t Tier>
inline void vec_sub_kernel(int8_t* a, int8_t* b, int8_t* c, ::std::size_t num) {
...
__global__ void vec_abs_kernel_(int8_t* a, int8_t* b, ::std::size_t num) {
  ...
  for (int i = 0; i < num_per_proc; ++i) {
    *(b + offset + i) = *(a + offset + i) < 0 ? -*(a + offset + i) : *(a + offset + i);
  }
  RISCV_FENCE_I;  // Flush cache
}
...
template<::std::size_t Kernel, ::std::size_t Tier>
inline void vec_abs_kernel(int8_t* a, int8_t* b, ::std::size_t num) {
...
template<::std::size_t Kernel, ::std::size_t Tier>
inline void vec_exp_kernel(int8_t* a, int8_t* b, ::std::size_t num) {
